...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = 'public/assets/WhatsApp Image 2026-02-19 at 3.08.38 PM (1).jpeg',
  ...
  const [height, setHeight] = useState('80svh');
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-full absolute left-1/2 top-1/2 will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translate(-50%, -50%) translateZ(0) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.01))',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
